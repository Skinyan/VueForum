  ...
  <div class="container">
    <div class="flex-grid">
      <div class="col-3 push-top">
        <UserProfileCard :user="user" :userPosts="userPosts" />
        <UserProfilCardEditor :user="user" />
...
import UserProfilCardEditor from "@/components/UserProfilCardEditor";

export default {
  components: { PostList, UserProfileCard, UserProfilCardEditor },
  props: {
